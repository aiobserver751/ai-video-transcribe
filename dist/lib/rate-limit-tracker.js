...
function loadConfig() {
    return {
        tier: process.env.GROQ_TIER || DEFAULT_CONFIG.tier,
 ...
 */
function extractUsedSeconds(errorMessage) {
 ...
 */
function calculateTimeUntilReset(errorMessage) {
...
export class GroqRateLimitTracker {
     ...
     */
    trackWhisperUsage(audioSeconds) {
